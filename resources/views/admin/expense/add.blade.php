...
@component('admin.dashboard.bredcumb')
  @slot('title')
    Add Expense
  @endslot
  <li><a href="{{url('admin/expense/create')}}">Add</a></li>
@endcomponent

<div class="row">
    <div class="col-md-12">
      <form class="form-horizontal" action="{{url('admin/expense')}}" method="post" enctype="multipart/form-data">
        @csrf
          <div class="panel panel-default">
              <div class="panel-heading">
                  <div class="row">
                    <div class="col-md-8">
                      <h3 class="panel-title"><i class="fa fa-cubes"></i> Add Expense</h3>
                    </div>
              ...
              <div class="panel-body">
                    ...
                    <div class="form-group {{$errors->has('date')? 'has-error':''}}">
                        <label class="col-sm-3 control-label">Expense Date<span class="req_star">*</span></label>
                        <div class="col-sm-7" >
